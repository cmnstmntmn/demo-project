// https://github.com/kawan16/mithril-storage
var CookieStorage = require('./services/storage/cookie-storage');
var LocalStorage = require('./services/storage/local-storage');
var SessionStorage = require('./services/storage/session-storage');
var InMemoryStorage = require('./services/storage/in-memory-storage');
